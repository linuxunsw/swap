/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: d3257d578d65fa1098f74878ffd5b244)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		SECONDARY_STORAGE_KV: KVNamespace;
		DB: D1Database;
		MAIL_RATE_LIMIT: RateLimit;
		...
		CONSOLE_MAILER: string;
		OTP_EXPIRY_MINS: string;
		RATE_LIMIT_BYPASS: string;
		PUBLIC_TURNSTILE_SITE_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		PUBLIC_SOCIETY_EMAIL: string;
		PUBLIC_SOCIETY_WEBSITE: string;
		PUBLIC_SWAP_GITHUB: string;
	}
	interface Env {
		SECONDARY_STORAGE_KV: KVNamespace;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEON_DATABASE_URL" | "ORIGIN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_SESSION_EXPIRES_IN" | "BETTER_AUTH_SESSION_UPDATE_AGE" | "ADMIN_ZIDS" | "LOG_DEV_ONLY" | "LOG_DEBUG" | "RESEND_API_KEY" | "MAILER_FROM_EMAIL" | "CONSOLE_MAILER" | "OTP_EXPIRY_MINS" | "RATE_LIMIT_BYPASS" | "PUBLIC_TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "PUBLIC_SOCIETY_EMAIL" | "PUBLIC_SOCIETY_WEBSITE" | "PUBLIC_SWAP_GITHUB">> {}
}
